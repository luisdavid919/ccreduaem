...
<div class="container">
  ...
  <div class="container">
  	<div class="row">
  		<div class="col">
  			<a href="http://localhost/ccreduaem/userPC.php" class="btn btn-info bg-dark m-1" role="button"><i class="fas fa-hdd"></i> CPU</a>
  			<a href="http://localhost/ccreduaem/userMON.php" class="btn btn-info bg-primary m-1" role="button"><i class="fas fa-desktop"></i> Monitores</a>
  			<a href="http://localhost/ccreduaem/userKEY.php" class="btn btn-warning m-1" role="button"><i class="fas fa-keyboard"></i> Teclados</a>
  			<a href="http://localhost/ccreduaem/userMOU.php" class="btn btn-light m-1" role="button"><i class="fas fa-mouse-pointer"></i> Mouse's</a>
 		</div>
  	</div>
  </div>
