    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
        	<div class="modal-header">                      
                        <h4 class="modal-title" id="myModalLabel">Agregar Datos Del Mouse</h4>
			...
			<form method="POST" action="AgregarNuevo.php">
                        ...
                        <p class="text-center"><strong>Si el Mouse se encuentra en mal estado por favor solicite su reporte.</strong></p>
                        </div>
            </div> 
