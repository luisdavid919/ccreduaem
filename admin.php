...
<img class="img img-fluid" src="images\uaem_logo.png"/>
  ...
  <div class="container">
    <div class="row justify-content-around mt-2">
      ...
      <a class="btn btn-primary bg-primary" href="http://localhost/ccreduaem/bdpc/consulta_pc.php" role="button">Equipos</a>
      </div>
      </div>
<!--*****************DISPOSITIVOS*****************-->
      <div class="col col-4 col-sm-3 col-md-3 col-lg-2">
        ...
        <div class="col col-8 col-sm-8 col-md-6 col-lg-2">
      <a class="btn btn-primary bg-primary" href="http://localhost/ccreduaem/consulta_dispad.php" role="button">Dispositivos</a>
      </div>
      </div>
<!--*****************USUARIOS*****************-->
      <div class="col col-4 col-sm-3 col-md-3 col-lg-2">
...
<!--*****************BITÁCORA*****************-->
      <div class="col col-4 col-sm-3 col-md-3 col-lg-2">
        ...
        <div class="col col-8 col-sm-8 col-md-6 col-lg-2">
        <a class="btn btn-primary bg-primary" href="http://localhost/ccreduaem/consulta_bitad.php" role="button">Bitácora</a>
      </div>
      </div>
    </div>
  </div>
