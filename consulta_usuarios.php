        ...
        <div class="col-xs-4 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <div class="form-group row justify-content-center">
                <div class="col col-xs-2 col-sm-4 col-md-4 col-lg-2 col-xl-2 m-2">
                  <a class="btn btn-info btn-lg w-100" href="http://localhost/ccreduaem/consulta_admin.php" role="button">Ir a Admin</a>
                </div>
                <div class="col col-xs-2 col-sm-4 col-md-4 col-lg-2 col-xl-2 m-2">
                  <a class="btn btn-info btn-lg w-100" href="http://localhost/ccreduaem/admin_usuarios.php" role="button">Agregar</a>
                </div>
              </div>
            </div>
