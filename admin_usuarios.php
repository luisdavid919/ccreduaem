            ...
            <input type="text" class="form-control" name="periodo" id="periodo">
              ...
              <div class="col col-xs-8 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                <input type="text" class="form-control" name="password" id="password">
                          ...
                          <!--*****************BOTONES*****************-->
      <div class="col-xs-4 col-sm-12 col-md-12 col-lg-2 col-xl-2 align-self-center">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col justify-content-start mt-5">
          <a href="http://localhost/ccreduaem/consulta_usuarios.php" data-toggle="tooltip" data-placement="right" title="Regresar"><i class="icon-back"></i></a>
        </div>
      </div>
    </div>
    <!--*****************Finaliza Formulario*****************-->
