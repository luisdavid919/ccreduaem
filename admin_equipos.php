      ...
      <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-8 d-block d-sm-block d-md-block">
        <form action="">
          <div class="form-group row mt-2">
            ...
            <div class="col col-6">
              <label for="clave">Clave UAEM:</label>
          ...
          <div class="col col-6 mt-2">
              <label for="turno">S.O:</label>
              <input type="so" class="form-control" name="so" id="so">
          </div>
          <div class="col col-6 mt-2">
              <label for="express">Express Service Code:</label>
              <input type="text" class="form-control" name="express" id="express">
          </div>
          <div class="col col-6 mt-2">
              <label for="servicetag">Service Tag:</label>
              <input type="text" class="form-control" name="servicetag" id="servicetag">
          </div>
        </form>
      </div>
      </div>
